...
const AudioPlayer = () => {
    ...
    return ( 
        <div className="audioPlayer">
             ...
             */}
            <button onClick={backwardThirty} className="forwardBackward"> <BsArrowLeftShort /> 30</button>

            <button onClick={togglePlayPause} className="playPause"> 
               { isPlaying ? <FaPause /> : <FaPlay className={styles.play} /> }
            </button>

            <button onClick={forwardThirty} className="forwardBackward"><BsArrowRightShort /> 30</button>
            ...
            {/* progress bar */}
            <div>
                <input type="range" ref={progressBar} className="" defaultValue="0"
