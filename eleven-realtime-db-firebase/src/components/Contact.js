...
const Contact = ({ contact, contactKey }) => {
  ...
  const deleteContact = () => {
    ...
    .remove()
    .then( () => {
      toast("Contact deleted siccessfully ", {type:"warning"})
    })
    .catch(error => {
      console.error(error);
      toast("erroe in deleting ", {type:"error"})
  })
  };
  ...
  const updateImpContact = () => {
    ...
    .then( () => {
      toast("Contact Updated ", {type:"warning"})
    })
    .catch(err => {
      console.error(err);
    })
      ...
      <Row>
        ...
        >
          ...
          <MdDelete
            ...
            color="danger"
            className="text-danger icon mx-5 "
          />
        </Col>
      </Row>
    </>
